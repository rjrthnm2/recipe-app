...
- **Accent:** Vibrant Teal (`#0D9488`) — Strict use for primary buttons and active states (accent vase color).
...
- **Landing Page:** Flowy, slow-moving CSS gradient mesh (water/silk vibe bridging deep navy and teal).
